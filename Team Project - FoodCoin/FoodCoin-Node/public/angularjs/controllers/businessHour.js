 ...
 */
index.controller("businessHour",['$scope','$http','$state' ,'$stateParams',function($scope,$http ,$state,$stateParams){


console.log(" Hello from business hour");
...
console.log("$state", $stateParams);
   ...
   $scope.next = function()
   {
       ...
       $stateParams.days=day;
       console.log("days",$stateParams);
       $state.go("businessTime",{"schedule":$stateParams});
