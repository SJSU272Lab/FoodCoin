...
#     attendee_emails.append(row[3])
#     attendee_emails.append(row[4])
#     my_data.append(attendee_emails)
#     attendee_emails = []
#
# print my_data
# print "*************************************************************"
...
#set1,set2=divideset(my_data,0,lt4)
#print entropy(set1)
#print entropy(set2)
...
# print "Amount of order is :- "
# print classify(['Friday','N','5','60'],tree)
# print classify(['Tuesday','N','4','100'],tree)
# print classify(['Saturday','Y','6','120'],tree)
# print classify(['Wednesday','N','5','80'],tree)
